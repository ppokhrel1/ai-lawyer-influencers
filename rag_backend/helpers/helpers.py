...
def check_model_drift(current_answer: str, previous_answers: List[str], window_size: int = 20, threshold: int = 50) -> bool:
    """
    ...
    last_n_answers = previous_answers[-window_size:]
    avg_previous_length = mean(len(ans) for ans in last_n_answers) if last_n_answers else 0
